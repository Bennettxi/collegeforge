  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-500 dark:text-gray-300 text-center mb-12 max-w-xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map((f) => (
            <Card
              ...
              hover
              className={cn(
                'glass-card text-center transition-all duration-300 border-l-4',
                f.borderAccent
              )}
            >
              <div className={cn(
              ...
              <p className="text-gray-500 dark:text-gray-300 text-sm leading-relaxed">{f.description}</p>
            </Card>
          ))}
        </div>
      </div>
